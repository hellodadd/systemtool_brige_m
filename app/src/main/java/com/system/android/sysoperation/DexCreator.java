...
import static com.system.android.sysoperation.SysOperationHelpers.inputStreamToByteArray;
...
/*package*/ class DexCreator {
	...
	public static File getDefaultFile(String childClz) {
		return new File(DALVIK_CACHE, "sysoperation_" + childClz.substring(childClz.lastIndexOf('.') + 1) + ".dex");
	}
