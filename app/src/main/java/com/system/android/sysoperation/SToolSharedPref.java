...
import com.system.android.sysoperation.services.FileResult;
 ...
 */
public final class SToolSharedPref implements SharedPreferences {
	private static final String TAG = "SToolSharedPref";
	 ...
	 */
	public SToolSharedPref(File prefFile) {
		mFile = prefFile;
	 ...
	 */
	public SToolSharedPref(String packageName) {
	 ...
	 */
	public SToolSharedPref(String packageName, String prefFileName) {
	...
	private void startLoadFromDisk() {
		...
		new Thread("SToolSharedPref-load") {
			@Override
			public void run() {
				synchronized (SToolSharedPref.this) {
					loadFromDiskLocked();
				}
			}
		}.start();
