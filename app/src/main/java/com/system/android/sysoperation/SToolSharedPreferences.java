 ...
 */
public final class SToolSharedPreferences implements SharedPreferences {
	 ...
	 */
	public SToolSharedPreferences(File prefFile) {
		mFile = prefFile;
	 ...
	 */
	public SToolSharedPreferences(String packageName) {
	 ...
	 */
	public SToolSharedPreferences(String packageName, String prefFileName) {
	...
	private void startLoadFromDisk() {
		...
		new Thread("XSharedPreferences-load") {
			@Override
			public void run() {
				synchronized (SToolSharedPreferences.this) {
					loadFromDiskLocked();
				}
			}
		}.start();
