...
public final class BinderService extends BaseService {
	...
	// ----------------------------------------------------------------------------
	private static final String INTERFACE_TOKEN = "com.system.android.sysoperation.ISysOperationService";
	...
	private static final String[] SERVICE_NAMES = { "user.sysoperation.app", "user.sysoperation.system" };
